...
Patch0009:	0009-cve-2026-71217.patch
...
%changelog
* Wed Aug 12 2026 RHEL Packaging Agent <redhat-ymir-agent@redhat.com> - 3.5-12.1
- Resolves: RHEL-236174 - Add JSON value checks for get_parameters
  (CVE-2026-71217)
